...
$conn = OpenCon();
$sql  = "SELECT *  FROM `atp_inventory` WHERE `material_number` LIKE '$search_term%'";
...
<?php			
				...
				//disclamer block
					echo"<ul>
					<li><small>Quantity available is based on current inventory.</small></li>
					...
					echo "<a class='btn btn-danger btn-block mt-4' href='index2.php'>Go Back</a>";
					echo "<ol>";
